...
const Carousel = (props) => {
    ...
    return <div className='carousel-body'  ref={carouselBodyRef}>
        <div className='img-body' ref={imgBodyRef}>
            {list.map((v,i)=>{
        ...
        <div className='btn-body' ref={btnBodyRef}>
            <button className='leftBtn' onClick = {handleToPrevPic}>left</button>
            ...
            <button className='rightBtn' onClick = {handleToNextPic}>right</button>
        </div>
    </div>
}
